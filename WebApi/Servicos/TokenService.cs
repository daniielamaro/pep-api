...
namespace WebApi.Servicos
{
    public class TokenService
    {
        ...
        public static string GenerateToken(Medico medico)
        {
            string secret = Startup.Configuration.GetSection("Secret").Value;
            ...
            var tokenDescriptor = new SecurityTokenDescriptor()
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                    new Claim(ClaimTypes.Sid, medico.Id.ToString()),
        ...
        public static string GenerateToken(Enfermeiro enfermeiro)
        {
            string secret = Startup.Configuration.GetSection("Secret").Value;
            ...
            var tokenDescriptor = new SecurityTokenDescriptor()
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                    new Claim(ClaimTypes.Sid, enfermeiro.Id.ToString()),
        ...
        public static string GenerateToken(AgenteAdministrativo agente)
        {
            string secret = Startup.Configuration.GetSection("Secret").Value;
            ...
            var tokenDescriptor = new SecurityTokenDescriptor()
            {
                Subject = new ClaimsIdentity(new Claim[]
                {
                    new Claim(ClaimTypes.Sid, agente.Id.ToString()),
